...
%%     Revision:  $Id: bash-hot-keys.tex,v 1.9 2008/10/03 10:47:49 mehner Exp $
%%      Created:  09.06.2003
%%                
%%        Notes:  
%%                
...
\newcommand{\PluginVersion}{2.7}
\newcommand{\ReleaseDate}{August 2008}
...
\hline \verb'\h'   & show plugin help \hfill (n) \\
\hline
\hline 
\hline
